...
namespace Framework {
    ...
    PUProfile stringToPUProfile(const std::string&);
    ...
    class PUReweighter {
        ...
        private:
            ...
            std::map<PUProfile, std::vector<float>> m_pu_profiles {
                {
                    // From https://github.com/cms-sw/cmssw/blob/CMSSW_8_0_X/SimGeneral/MixingModule/python/mix_2016_25ns_Moriond17MC_PoissonOOTPU_cfi.py
                    Moriond17_25ns,
                    {
                        1.78653e-05, 
                        2.56602e-05, 
                ...
                {
                    // From https://github.com/cms-sw/cmssw/blob/CMSSW_8_0_X/SimGeneral/MixingModule/python/mix_2016_25ns_SpringMC_PUScenarioV1_PoissonOOTPU_cfi.py
                    Spring16_25ns,
                    {
                        0.000829312873542,
                        0.00124276120498,
